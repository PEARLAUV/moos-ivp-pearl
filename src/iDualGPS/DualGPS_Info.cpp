...
void showExampleConfigAndExit()
{
  ...
  blk("                                                                            ");
  blk("  LEFT_PORT       = /dev/ttyUSB0  // Serial port address for PORT GPS       ");
  blk("  RIGHT_PORT      = /dev/ttyUSB1  // Serial port address for STARBOARD GPS  ");
  ...
  blk("                               // vector: heading is published from $GPRMC  ");
  blk("                               // based on velocity vector calculations     ");
  blk("                               // dual: heading is published by calculating ");
  blk("                               // difference in position of each GPS        ");
